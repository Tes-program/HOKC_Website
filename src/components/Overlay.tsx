...
export const Overlay: React.FC = () => {
  return (
    <div className="absolute w-full object-cover max-[375px]:h-[74vh] max-[430px]:h-[55vh] max-[400px]:h-[58vh] lg:h-[50vh] min-[1100px]:h-[95vh] max-[374px]:h-[65vh] md:h-[40vh] -my-80 bg-hero-pattern flex items-center h-[65vh] min-[1400px]:h-[40vh] min-[2560px]:bg-repeat-x justify-center bg-no-repeat ">
